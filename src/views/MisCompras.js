...
export default function Uploads() {
  ...
  return (
    <Fragment>
      ...
      <div className="labelarticulo">Articulo</div>
        <div className="labelprecio">Precio</div>
        <div className="labelcantidad">Cantidad</div>
        <div className="labeldescripcion">Descripcion</div>
        <div className="labelacciones">Acciones</div>
      </div>
        ...
        {datos.map((row) => {
          return (
            <div className="carrito">
              ...
              <div className="botones"><ButtonConIcon texto="" handleButton={() => eliminar(row.id)} /></div>
            </div>
          )
        })
        }
